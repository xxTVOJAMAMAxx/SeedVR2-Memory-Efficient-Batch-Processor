...
1. Configure your workflow once:
    ...
    Save workflow as JSON (e.g., my_workflow.json) - use export API in comfyui
...
Out of RAM
    ...
    Reduce batch size (try 16 or 12)
    Close other applications
    Check SeedVR2 model settings (reduce blocks_to_swap if needed)
...
Slow frame saving
    ...
    Lower compression_quality to 85-90
    Ensure multi-threading is working (check CPU usage)
